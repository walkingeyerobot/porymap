...
void TilesetEditor::drawMetatileLayersItem() {
    this->metatileLayersItem->draw();
    ui->graphicsView_metatileLayers->setFixedSize(this->metatileLayersItem->pixmap().width() + 2, this->metatileLayersItem->pixmap().height() + 2);
}
